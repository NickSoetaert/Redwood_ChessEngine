...
public class Game
{
    ...
    public void PlayDumbieGame()
    {
        ...
        while(i < 100000)
        {
            ...
            if (AIturn == curTurn)
            {
                ...
                advisedAction = OurGuy.Think(MoveGenerator.possibleWhiteMoves(board, pastMoves).getAlg(), "White");
    ...
    public void PlayAIDumbieGame()
    {
        ...
        while(i < 1000000)
        {
            ...
            {
                advisedAction = OurGuy.Think(MoveGenerator.possibleBlackMoves(board, pastMoves).getAlg(),"Black");
                OurGuy.act(advisedAction);
                curTurn = AIturn;
                System.out.println(OurGuy.ConfidenceinLastMove);
